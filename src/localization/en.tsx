export default {
  ...
  auth: {
    ...
    enterFoodLicenseNumber: 'Enter Food License Number',
    ...
    chooseUserType: 'Please Select the Type',
    ...
    enterCustomerCount: 'Enter customer count',
